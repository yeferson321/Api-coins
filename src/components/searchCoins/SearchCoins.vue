    ...
    <div class="mx-auto max-w-7xl px-2.5 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between pb-8">
            ...
            <a href="/favorites" class="relative sm:inline-flex sm:items-center sm:text-white p-1 sm:px-4 sm:py-1.5 sm:rounded-lg sm:bg-blue-600 sm:hover:bg-blue-700 sm:transition sm:duration-450 sm:ease-in-out">
                ...
                <div v-if="favoriteCoin.length" class="absolute inline-flex items-center justify-center w-5 sm:w-6 h-5 sm:h-6 text-xs font-bold text-white bg-blue-600 border-2 rounded-full bottom-1 sm:-top-2 -right-1 sm:-right-2 border-gray-900">
                    {{ favoriteCoin.length }}
                </div>
            </a>
        </div>
